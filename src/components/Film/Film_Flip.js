...
export default function Film_Flip(props) {
  ...
  return (
    <div className="flip-card mt-2">
            ...
            <NavLink to={`/detail/${item.maPhim}`} style={{display: 'block'}} className=" text-center cursor-pointer p-2 leading-5 bg-indigo-300 my-2 text-success-50 font-bold w-full">ĐẶT VÉ</NavLink>
        </div>
  );
}
