...
export default function BaiTapTongHop() {
  ...
  console.log(mangDanhMuc, maDanhMuc);

  return (
    //flex chia theo with
    //còn grid chia theo lưới col-span
    <div>
      ...
      <div className="grid grid-cols-6">
                  ...
                  >
                    ...
                    >
                      <svg
                        ...
                        viewBox="0 0 512 512"
                        className="w-5 h-5 fillCurrent text-coolGray-600"
                      >
        ...
        <div className="col-span-5">
          <h3 className="text-center text-purple-500 text-8xl pt-5">Menu</h3>
            ...
            <div className="container px-5 py-24 mx-auto">
              <div className="flex flex-wrap -m-4">
                {data
                  ...
                  .map((item) => {
                    return (
                      <div className="p-4 lg:w-1/3" key={item.maMonAn}>
                        <div className="h-full bg-gray-100 bg-opacity-75 px-8 pt-16 pb-24 rounded-lg overflow-hidden text-center relative">
                          ...
                          <div className="text-center leading-none flex justify-end absolute bottom-0 left-0 w-full py-4">
                            <span className="text-gray-400 mr-3 inline-flex items-center leading-none pr-3 py-1 text-xl">
                              Giá: {item.gia}
                            </span>
                          </div>
                        </div>
