...
export default function Login(props) {
    ...
    const formik = useFormik({
        ...
        onSubmit: values => {
          ...
          //này redux-thunk ở trên action x trả ra mới bắn lên redux
          dispatch(action);
    ...
    return (
        <form onSubmit={(event) => {
            ...
            //formik nó xử lý r mà để vậy cho biết
                ...
                <div className="mt-12">
                    <div>
                        ...
                        <div className="mt-8">
                            ...
                            <input type="password" onChange={formik.handleChange} name="matKhau" className="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500"  placeholder="Nhập vào mật khẩu" />
                        </div>
                        <div className="mt-10">
